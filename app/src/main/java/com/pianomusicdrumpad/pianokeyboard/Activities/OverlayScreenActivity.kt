...
class OverlayScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (SharePrefUtils.getString(ConstantAd.navBarEnablePermissionScreen, "0") == "1") {
            window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_HIDE_NAVIGATION or
                    View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY or View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR
        }


        setContentView(R.layout.activity_cm_overlay_screen)
...
//                startActivity(i)
        ...
        tvTurmCondition!!.setOnClickListener {
            ...
            if (!Utility.isConnectivityAvailable(this)) {
                ...
                val `in` = Intent(this@OverlayScreenActivity, PrivacyPolicyActivity::class.java)
                startActivity(`in`)
            }
        }
...
//            startActivity(i)
            if (!Settings.canDrawOverlays(this)) {
                ...
                val i = Intent(this@OverlayScreenActivity, MenuActivity::class.java)
                startActivity(i)
            }
        } else {
